...
NEW_SPECIES_VARIANTS = {
    ...
    "reuniclus": (
        "magicguardspdef",
        "regeneratortrickroom",
        "magicguardbreaker",
        "magicguardcalmmind",
        "regeneratorphysicalwall",
    ),
}
...
EXPECTED_HUMAN_SETS = {
    ("kabutops", "sashlead"): _expected(
        ...
        (4, 252, 0, 0, 0, 252),
        IVS_31,
        ("stealthrock", "flipturn", "knockoff", "stoneedge"),
        "fast Focus Sash hazard lead and pivot",
    ),
    ("kabutops", "bootsspinner"): _expected(
        3,
        "plausible",
        "heavydutyboots",
        "weakarmor",
        ...
        (4, 252, 0, 0, 0, 252),
        IVS_31,
        ("stealthrock", "rapidspin", "flipturn", "stoneedge"),
        "fast hazard setter, remover, and pivot",
    ),
    ("kabutops", "sashsetup"): _expected(
        2,
        "experimental",
        "focussash",
        "weakarmor",
        ...
        (4, 252, 0, 0, 0, 252),
        IVS_31,
        ("swordsdance", "stoneedge", "liquidation", "knockoff"),
        "Focus Sash physical setup attacker",
    ),
    ("kangaskhan", "choiceband"): _expected(
        4,
        "established",
        "choiceband",
        "scrappy",
        ...
        (0, 252, 0, 0, 4, 252),
        IVS_31,
        ("hammerarm", "earthquake", "suckerpunch", "doubleedge"),
        "immediate Scrappy physical wallbreaker",
    ),
    ("kangaskhan", "bootsoffense"): _expected(
        3,
        "plausible",
        "heavydutyboots",
        "scrappy",
        ...
        (0, 252, 0, 0, 4, 252),
        IVS_31,
        ("fakeout", "earthquake", "doubleedge", "suckerpunch"),
        "fast Boots attacker with dual priority",
    ),
    ("kangaskhan", "earlybirdtrapper"): _expected(
        2,
        "experimental",
        "heavydutyboots",
        "earlybird",
        ...
        (252, 0, 0, 0, 200, 56),
        IVS_0_ATK,
        ("whirlpool", "seismictoss", "rest", "toxic"),
        "specially defensive trapping and Rest utility",
    ),
    ("kangaskhan", "substitute"): _expected(
        2,
        "experimental",
        "leftovers",
        "scrappy",
        ...
        (252, 0, 124, 0, 132, 0),
        IVS_31,
        ("substitute", "toxic", "poweruppunch", "return"),
        "bulky Substitute and Power-Up Punch attacker",
    ),
    ("leavanny", "sashwebs"): _expected(
        4,
        "established",
        "focussash",
        "chlorophyll",
        ...
        (0, 252, 0, 0, 4, 252),
        IVS_31,
        ("stickyweb", "knockoff", "tripleaxel", "leafblade"),
        "Focus Sash Sticky Web lead with physical coverage",
    ),
    ("leavanny", "ejectpackwebs"): _expected(
        3,
        "plausible",
        "ejectpack",
        "chlorophyll",
        ...
        (0, 252, 0, 4, 0, 252),
        IVS_31,
        ("stickyweb", "knockoff", "tripleaxel", "leafstorm"),
        "Sticky Web lead using Leaf Storm and Eject Pack for momentum",
    ),
    ("leavanny", "swarmwebs"): _expected(
        3,
        "plausible",
        "focussash",
        "swarm",
        ...
        (0, 252, 0, 0, 4, 252),
        IVS_31,
        ("stickyweb", "knockoff", "tripleaxel", "lunge"),
        "Focus Sash Sticky Web lead using Swarm pressure",
    ),
    ("leavanny", "sashsetup"): _expected(
        2,
        "experimental",
        "focussash",
        "chlorophyll",
        ...
        (0, 252, 0, 0, 4, 252),
        IVS_31,
        ("swordsdance", "knockoff", "tripleaxel", "leafblade"),
        "Focus Sash physical setup attacker",
    ),
    ("lilligant", "sashquiverdance"): _expected(
        4,
        "established",
        "focussash",
        "chlorophyll",
        ...
        (4, 0, 0, 252, 0, 252),
        IVS_0_ATK,
        ("quiverdance", "sleeppowder", "gigadrain", "hiddenpowerfire60"),
        "Focus Sash Quiver Dance and Sleep Powder setup attacker",
    ),
    ("lilligant", "lifeorbquiverdance"): _expected(
        3,
        "plausible",
        "lifeorb",
        "chlorophyll",
        ...
        (0, 0, 0, 252, 4, 252),
        IVS_0_ATK,
        ("quiverdance", "gigadrain", "alluringvoice", "encore"),
        "Life Orb Quiver Dance attacker with Encore utility",
    ),
    ("mismagius", "substitutesetup"): _expected(
        3,
        "plausible",
        "leftovers",
        "levitate",
        ...
        (0, 0, 0, 252, 4, 252),
        IVS_0_ATK,
        ("nastyplot", "shadowball", "drainingkiss", "substitute"),
        "Leftovers Substitute and Nasty Plot attacker",
    ),
    ("mismagius", "lifeorbsetup"): _expected(
        4,
        "established",
        "lifeorb",
        "levitate",
        ...
        (0, 0, 0, 252, 4, 252),
        IVS_0_ATK,
        ("nastyplot", "shadowball", "dazzlinggleam", "mysticalfire"),
        "Life Orb Nasty Plot wallbreaker",
    ),
    ("mismagius", "choicescarf"): _expected(
        3,
        "plausible",
        "choicescarf",
        "levitate",
        ...
        (0, 0, 0, 252, 4, 252),
        IVS_0_ATK,
        ("shadowball", "dazzlinggleam", "psychic", "trick"),
        "Choice Scarf revenge killer and Trick utility",
    ),
    ("mismagius", "choicespecs"): _expected(
        2,
        "experimental",
        "choicespecs",
        "levitate",
        ...
        (0, 0, 0, 252, 4, 252),
        IVS_0_ATK,
        ("shadowball", "dazzlinggleam", "destinybond", "trick"),
        "experimental Choice Specs attacker with Trick and Destiny Bond",
    ),
    ("mukalola", "resttalk"): _expected(
        3,
        "plausible",
        "blacksludge",
        "poisontouch",
        ...
        (252, 0, 4, 0, 252, 0),
        IVS_31,
        ("knockoff", "poisonjab", "rest", "sleeptalk"),
        "specially defensive RestTalk utility",
    ),
    ("mukalola", "assaultvest"): _expected(
        4,
        "established",
        "assaultvest",
        "poisontouch",
        ...
        (204, 252, 0, 0, 52, 0),
        IVS_31,
        ("pursuit", "poisonjab", "knockoff", "fireblast"),
        "bulky mixed-coverage Assault Vest attacker and Pursuit trapper",
    ),
    ("mukalola", "choiceband"): _expected(
        3,
        "plausible",
        "choiceband",
        "poisontouch",
        ...
        (252, 252, 0, 0, 4, 0),
        IVS_31,
        ("knockoff", "gunkshot", "firepunch", "shadowsneak"),
        "immediate Choice Band physical wallbreaker",
    ),
    ("raichu", "choiceband"): _expected(
        3,
        "plausible",
        "choiceband",
        "lightningrod",
        ...
        (4, 252, 0, 0, 0, 252),
        IVS_31,
        ("voltswitch", "knockoff", "extremespeed", "volttackle"),
        "fast physical Choice Band attacker with deliberate Volt Switch momentum",
    ),
    ("raichu", "sashnastyplot"): _expected(
        4,
        "established",
        "focussash",
        "lightningrod",
        ...
        (4, 0, 0, 252, 0, 252),
        IVS_0_ATK,
        ("nastyplot", "thunderbolt", "hiddenpowerice60", "grassknot"),
        "Focus Sash Nasty Plot attacker",
    ),
    ("raichu", "bootsutility"): _expected(
        3,
        "plausible",
        "heavydutyboots",
        "lightningrod",
        ...
        (4, 252, 0, 0, 0, 252),
        IVS_31,
        ("voltswitch", "encore", "knockoff", "nuzzle"),
        "fast Boots pivot and disruption utility",
    ),
    ("reuniclus", "magicguardspdef"): _expected(
        3,
        "plausible",
        "lifeorb",
        "magicguard",
        ...
        (252, 4, 0, 0, 252, 0),
        IVS_31,
        ("psyshock", "knockoff", "recover", "shadowball"),
        "specially defensive Magic Guard Life Orb utility attacker",
    ),
    ("reuniclus", "regeneratortrickroom"): _expected(
        3,
        "plausible",
        "heavydutyboots",
        "regenerator",
        ...
        (248, 0, 0, 8, 252, 0),
        IVS_0_ATK_SPEED,
        ("trickroom", "recover", "futuresight", "encore"),
        "minimum-Speed Regenerator Trick Room support",
    ),
    ("reuniclus", "magicguardbreaker"): _expected(
        4,
        "established",
        "lifeorb",
        "magicguard",
        ...
        (252, 0, 0, 212, 0, 44),
        IVS_31,
        ("psychicnoise", "knockoff", "focusblast", "recover"),
        "Magic Guard Life Orb wallbreaker with recovery",
    ),
    ("reuniclus", "magicguardcalmmind"): _expected(
        3,
        "established",
        "leftovers",
        "magicguard",
        ...
        (252, 0, 252, 0, 4, 0),
        IVS_31,
        ("calmmind", "psychicnoise", "knockoff", "recover"),
        "physically defensive Calm Mind win condition",
    ),
    ("reuniclus", "regeneratorphysicalwall"): _expected(
        3,
        "plausible",
        "heavydutyboots",
        "regenerator",
        ...
        (252, 0, 252, 0, 4, 0),
        IVS_31,
        ("psychicnoise", "knockoff", "thunderwave", "recover"),
        "physically defensive Regenerator utility",
    ),
    ("jynx", "choicespecs"): _expected(
        4,
        "established",
        "choicespecs",
        "dryskin",
        ...
        (0, 0, 0, 252, 4, 252),
        IVS_0_ATK,
        ("trick", "psyshock", "icebeam", "shadowball"),
        "fast Choice Specs wallbreaker with Trick",
    ),
    ("jynx", "sashunburden"): _expected(
        3,
        "plausible",
        "focussash",
        "unburden",
        ...
        (0, 0, 0, 252, 4, 252),
        IVS_0_ATK,
        ("nastyplot", "psyshock", "icebeam", "energyball"),
        "Focus Sash Nasty Plot attacker with Unburden potential",
    ),
    ("jynx", "throatspray"): _expected(
        2,
        "experimental",
        "throatspray",
        "unburden",
        ...
        (0, 0, 0, 252, 4, 252),
        IVS_0_ATK,
        ("hypervoice", "icebeam", "focusblast", "psychic"),
        "Throat Spray special attacker with Unburden activation",
    ),
    ("jynx", "bootsutility"): _expected(
        3,
        "plausible",
        "heavydutyboots",
        "dryskin",
        ...
        (0, 0, 0, 252, 4, 252),
        IVS_0_ATK,
        ("encore", "icebeam", "psyshock", "focusblast"),
        "fast Boots attacker and Encore utility",
    ),
    ("lapras", "chillyreception"): _expected(
        4,
        "established",
        "heavydutyboots",
        "ancientshell",
        ...
        (248, 0, 0, 252, 8, 0),
        IVS_0_ATK,
        ("chillyreception", "freezedry", "surf", "healbell"),
        "bulky Ancient Shell pivot and cleric",
    ),
    ("lapras", "dragondance"): _expected(
        3,
        "plausible",
        "loadeddice",
        "ancientshell",
        ...
        (4, 252, 0, 0, 0, 252),
        IVS_31,
        ("dragondance", "iciclespear", "liquidation", "earthquake"),
        "Loaded Dice physical setup attacker",
    ),
    ("lapras", "waterabsorboffense"): _expected(
        3,
        "plausible",
        "heavydutyboots",
        "waterabsorb",
        ...
        (0, 0, 196, 252, 0, 60),
        IVS_0_ATK,
        ("freezedry", "hydropump", "alluringvoice", "icebeam"),
        "bulky Water Absorb special attacker",
    ),
    ("lapras", "choicespecs"): _expected(
        2,
        "plausible",
        "choicespecs",
        "ancientshell",
        ...
        (80, 0, 0, 252, 0, 176),
        IVS_0_ATK,
        ("freezedry", "hydropump", "icebeam", "hiddenpowerfire60"),
        "Ancient Shell Choice Specs special wallbreaker",
    ),
    ("lapras", "perishtrap"): _expected(
        2,
        "experimental",
        "chestoberry",
        "ancientshell",
        ...
        (252, 0, 4, 0, 252, 0),
        IVS_0_ATK,
        ("perishsong", "whirlpool", "rest", "freezedry"),
        "specially defensive Perish Song and Whirlpool trapper",
    ),
    ("mawile", "sashmixed"): _expected(
        3,
        "plausible",
        "focussash",
        "closingjaws",
        ...
        (0, 252, 0, 4, 0, 252),
        IVS_31,
        ("knockoff", "ironhead", "flamethrower", "playrough"),
        "fast mixed Focus Sash attacker using Closing Jaws",
    ),
    ("mawile", "choiceband"): _expected(
        4,
        "established",
        "choiceband",
        "closingjaws",
        ...
        (248, 252, 0, 0, 8, 0),
        IVS_31,
        ("suckerpunch", "ironhead", "knockoff", "playrough"),
        "bulky Choice Band Closing Jaws wallbreaker",
    ),
    ("obstagoon", "partingshot"): _expected(
        4,
        "established",
        "flameorb",
        "guts",
        ...
        (0, 252, 0, 0, 4, 252),
        IVS_31,
        ("facade", "knockoff", "closecombat", "partingshot"),
        "Guts wallbreaker and Parting Shot pivot",
    ),
    ("obstagoon", "obstruct"): _expected(
        3,
        "plausible",
        "flameorb",
        "guts",
        ...
        (0, 252, 0, 0, 4, 252),
        IVS_31,
        ("facade", "knockoff", "closecombat", "obstruct"),
        "Guts wallbreaker using Obstruct for activation and scouting",
    ),
    ("porygon2", "tracedefensive"): _expected(
        4,
        "established",
        "eviolite",
        "trace",
        ...
        (252, 0, 0, 4, 252, 0),
        IVS_0_ATK,
        ("toxic", "recover", "icebeam", "thunderbolt"),
        "specially defensive Trace utility",
    ),
    ("porygon2", "downloadoffense"): _expected(
        3,
        "plausible",
        "eviolite",
        "download",
        ...
        (252, 0, 0, 252, 4, 0),
        IVS_0_ATK,
        ("triattack", "recover", "icebeam", "thunderbolt"),
        "Download-boosted bulky special attacker",
    ),
    ("porygon2", "trickroom"): _expected(
        3,
        "plausible",
        "eviolite",
        "trace",
        ...
        (252, 0, 0, 4, 252, 0),
        IVS_0_ATK_SPEED,
        ("teleport", "trickroom", "recover", "icebeam"),
        "minimum-Speed Trace Trick Room support and pivot",
    ),
    ("porygon2", "paralysisutility"): _expected(
        3,
        "plausible",
        "eviolite",
        "trace",
        ...
        (252, 0, 0, 4, 252, 0),
        IVS_0_ATK,
        ("thunderwave", "recover", "shadowball", "triattack"),
        "specially defensive paralysis utility",
    ),
}
...
class TestBatchFourDocument(unittest.TestCase):
    ...
    def test_01_encoding_hash_identity_and_inventories_are_exact(self):
        ...
        self.assertEqual(
            20, sum(map(len, REPLACEMENT_VARIANTS.values())) + len(CLAYDOL_VARIANTS)
        )
    ...
    def test_02_version_1_3_semantics_change_only_as_authorized(self):
        ...
        old_tr = next(
            v
            for v in old_claydol["variants"]
            if v["variant_id"] == "regeneratortrickroom"
        )
        ...
        self.assertEqual(
            CLAYDOL_VARIANTS,
            tuple(v["variant_id"] for v in new_records["claydol"]["variants"]),
        )
    ...
    def test_05_real_teamvalidator_accepts_all_required_groups(self):
        ...
        unusual = {
            ("jynx", "throatspray"),
            ("kangaskhan", "earlybirdtrapper"),
            ("kangaskhan", "substitute"),
            ("lapras", "chillyreception"),
            ("lapras", "waterabsorboffense"),
            ("lapras", "choicespecs"),
            ("leavanny", "sashwebs"),
            ("leavanny", "ejectpackwebs"),
            ("lilligant", "sashquiverdance"),
            ("mawile", "sashmixed"),
            ("mismagius", "choicespecs"),
            ("mukalola", "assaultvest"),
            ("raichu", "choiceband"),
            ("raichu", "sashnastyplot"),
        ...
        groups.extend(
            [
                ...
                {
                    "label": "batch4-claydol",
                    "entries": _entries(
                        docs["1.4.0"],
                        lambda species, variant: species["species_id"] == "claydol",
                    ),
                },
                {
                    "label": "batch4-claydol-corrected",
                    "entries": _entries(
                        docs["1.4.0"],
        ...
        self.assertEqual(
            [
                ...
                "1.4.0:132/132",
                "batch4-new:28/28",
                "batch4-replacements:17/17",
                "batch4-claydol:3/3",
                "batch4-claydol-corrected:1/1",
                "unusual-elements:18/18",
            ],
    ...
    def test_06_trick_room_hidden_power_and_deliberate_mixed_sets_are_exact(self):
        ...
        self.assertIn(
            "hiddenpowerfire60",
            dataset.get_species("lilligant").get_variant("sashquiverdance").move_ids,
        )
        self.assertIn(
            "hiddenpowerfire60",
            dataset.get_species("lapras").get_variant("choicespecs").move_ids,
        )
        self.assertIn(
            "hiddenpowerice60",
            dataset.get_species("raichu").get_variant("sashnastyplot").move_ids,
        )
    ...
    def test_07_authorization_firewall_and_negative_validators_are_exact(self):
        ...
        kabutops = next(
            ...
            if species["species_id"] == "kabutops"
        )
...
class TestBatchFourSelectionPopulationAndNarrowing(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.old_dataset = cls.old_configuration.registry.get(
            PublicPriorIdentity("tugspublicarchetypes", "1.3.0", "gen9tugs")
        )
    ...
    def test_09_all_28_unchanged_records_and_two_claydol_variants_are_stable(self):
        ...
        for variant_id in ("regeneratorrocks", "levitaterocks"):
            self.assertEqual(
                self.old_dataset.get_species("claydol").get_variant(variant_id),
                self.dataset.get_species("claydol").get_variant(variant_id),
            )
    ...
    def test_11_observation_narrowing_covers_all_fourteen_touched_species(self):
        ...
        checks = (
            ...
            (
                "kabutops",
                {"sashlead"},
                {"moves": ("stealthrock", "flipturn", "knockoff"), "item": "focussash"},
            ),
            ...
            (
                "leavanny",
                {"sashwebs", "swarmwebs"},
                {"moves": ("stickyweb",), "item": "focussash"},
            ),
            ...
            (
                "mukalola",
                {"resttalk", "assaultvest", "choiceband"},
                {"ability": "poisontouch"},
            ),
            ...
            (
                "reuniclus",
                {"magicguardspdef", "magicguardbreaker"},
                {"item": "lifeorb", "ability": "magicguard"},
            ),
            ...
            (
                "reuniclus",
                {"regeneratorphysicalwall"},
                {"moves": ("thunderwave",), "ability": "regenerator"},
            ),
            ...
            (
                "lapras",
                {"chillyreception", "dragondance", "choicespecs", "perishtrap"},
                {"ability": "ancientshell"},
            ),
            ...
            (
                "obstagoon",
                {"partingshot", "obstruct"},
                {
                    "moves": ("facade", "knockoff", "closecombat"),
                    "item": "flameorb",
                    "ability": "guts",
                },
            ),
            ...
            (
                "porygon2",
                {"tracedefensive", "trickroom", "paralysisutility"},
                {"ability": "trace"},
            ),
            (
                "porygon2",
                {"downloadoffense", "paralysisutility"},
                {"moves": ("triattack",)},
            ),
    ...
    def test_12_conflicts_ambiguity_and_removed_variants_are_isolated(self):
        context = self.none_configuration.create_battle_context("gen9tugs")
        conflict = _evidence(
            context, "kabutops", moves=("swordsdance",), item="heavydutyboots"
        )
        result = select_public_prior_variant(
            context,
            battle_format="gen9tugs",
        ...
        self.assertEqual(
            ...
            _compatible_ids(
                self.dataset,
                "mismagius",
                _evidence(context, "mismagius", moves=("trick",)),
            ),
        )
        old_ids = {
        ...
        self.assertEqual(
            {
                species: set(variants)
                for species, variants in REPLACEMENT_VARIANTS.items()
            },
            {
                species: {
                    variant.variant_id
                    for variant in self.dataset.get_species(species).variants
                }
